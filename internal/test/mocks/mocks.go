...
type MockConfigReader struct {
	...
	FileFilterCfg config.FileFilterConfig
	Exclude       []string
}
...
// GetFileFilterConfig 模拟获取全局文件过滤配置
func (m *MockConfigReader) GetFileFilterConfig() config.FileFilterConfig { return m.FileFilterCfg }

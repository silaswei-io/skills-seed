...
func Info(msg string, args ...any) {
	...
	progress.PrintConsoleLine(colorize(msg, ansiWhite))
...
func InfoAfterProgress(msg string, args ...any) {
	progress.PrintConsoleLineAfterProgress(colorize(msg, ansiWhite))
...
func Warn(msg string, args ...any) {
	...
	progress.PrintConsoleLine(colorize(msg, ansiYellow))
...
func Error(msg string, args ...any) {
	...
	progress.PrintConsoleLineNow(colorize(msg, ansiRed))

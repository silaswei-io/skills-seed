...
func TestFromPatternKeepsUnverifiedContentAsObservation(t *testing.T) {
	...
	item := ClaimFromPattern(*pattern, "en-US")

	require.Equal(t, ClaimStrengthObservation, item.Strength)

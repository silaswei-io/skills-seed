...
| `learning-knowledge-review` | `CodexAgent.ReviewKnowledge`, `ClaudeAgent.ReviewKnowledge` | Independently accept, narrow, or reject every source-learning candidate before semantic normalization. |

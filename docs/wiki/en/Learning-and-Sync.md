...
- Learning-chain prompts default to omission of weak conclusions: planning keeps the smallest focus set, full analysis prefers `patterns: []`, delta defaults to `no_change`, review prefers the cheapest correct verdict, and normalization does not restyle single-source reviewed candidates.

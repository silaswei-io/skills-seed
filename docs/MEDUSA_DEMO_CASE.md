...
换句话说，任务 Skills 提供流程操作手册，Skills Seed 生成的 Skill 提供从代码中抽取的项目地图和约束索引。做文档时可加载 `writing-docs`；当文档或代码变更涉及 Medusa 的真实模块边界、业务状态机、生成产物或验证范围时，`skills-seed-skills` 提供贴近当前代码的上下文。

(function () {
  ...
  var copy = {
    ...
    en: {
      ...
      heroLead: "Skills Seed learns real team practices from current code, diffs, and durable context, then generates local Skills that guide agents through your project boundaries, business entries, and validation habits.",
